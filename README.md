...
> [!TIP]  
> You can use `Ctrl` + `Shift`+ `F` to search every file in both Visual Studio and Visual Studio Code. This can for example help you find every instance of `SuperStar` inside files in the whole project. Do note however that this does not apply to filenames.  
...
[XuuXiao](https://github.com/XuuXiao/) - porting LC-SuperStar for LC v50  
